...
const AllTask = () => {
    ...
    return (
        <div className='bg-[#1c1c1c] p-5 rounded mt-7 htext0 '>
            ...
            {userData.map(function(elem,idx){
                ...
                <h5 className='text-lg font-medium w-1/5 text-green-600'>{elem.taskNumbers.newTask}</h5>
                <h5 className='texttext-lg font-medium -lg font-medium w-1/5 text-red-600'>{elem.taskNumbers.failed}</h5>
            </div>
            })}
            </div>
        </div>
